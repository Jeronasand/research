# TradingBot Financial/Crypto/Equity Data Source Product Research (Pending)
...
This version records the user-provided `financial_crypto_equity_data_sources` catalog. The catalog marks `last_verified_at` as 2026-05-11. This pass did not re-verify every official link live.
...
| R2 specialized intelligence | Nansen, Arkham, Kaito, Santiment, Intrinio, Nasdaq Data Link, TuShare, AKShare, JQData | Wallet profiling, entity attribution, social narrative, fundamentals, alternative data, China market data | Validate the target use case before pricing and commercial terms |
...
| P1 | TuShare Pro | A-share / HK-share gap | A-shares, funds, indices, futures, macro | A-share data source, China quant research, localized financial data | Commercial licensing, minute data, financial quality, points and rate limits |
| P1 | AKShare | A-share / open-source data interface | Stocks, futures, options, funds, forex, bonds, indices, crypto | Prototyping, A-share exploration, informal supplement, academic research | Source licensing, production stability, interface maintenance, commercial fit |
